...
public class BurgerShop {
        ...
        System.out.println("--------------------------------------------------------------------------------\n");
         do {
            ...
            if(obj!=null) {
                ...
                do {
                    System.out.print("\n\nInvalid Model.Order ID. Do you want to enter again? (Y/N)>");
                    String option = input.next();
                    if (option.equalsIgnoreCase("Y")) {
                        Controller.clearConsole();
                        searchOrder();
    ...
    // View Model.Order list
    public static void viewOrders() {
        Scanner input = new Scanner(System.in);
        System.out.println("-------------------------------------------------------------------------");
        System.out.println("|\t\t\t\tVIEW ORDER LIST\t\t\t\t|");
        System.out.println("-------------------------------------------------------------------------\n");
        System.out.println("[1] Delivered Model.Order");
        System.out.println("[2] Preparing Model.Order");
        System.out.println("[3] Cancel Model.Order");
    ...
    public static void updateOrderDetails() {
        ...
        L1: do {
            ...
            if (status == "Cancel") {
                System.out.println("This Model.Order is already cancelled...You can not update this order...");
            }else if(status=="Delivered"){
                System.out.println("This Model.Order is already delivered...You can not update this order...");
            }else{
    ...
    public static void homePage() {
        ...
        System.out.println("-------------------------------------------------------------------------\n");
        System.out.println("[1] Place Model.Order\t\t\t[2] Search Best Customer");
        System.out.println("[3] Search Model.Order\t\t[4] Search Customer");
        System.out.println("[5] View Orders\t\t\t[6] Update Model.Order Details");
