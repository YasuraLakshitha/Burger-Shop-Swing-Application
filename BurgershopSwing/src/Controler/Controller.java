...
import DB.List;
import Model.Order;
import View.BurgerShop;

public class Controller {
    public static Order[] sorted = new Order[0];
    ...
    public static boolean addOrder(Order obj) {
   ...
   public static String isExistCustomer(String customerId){
    ...
    //Get Status
    public static String getStatus(Order obj){
    ...
    public static Order[] searchCustomersDetails(String customerId){
        Order[] customer = new Order[0];
        for(int i=0;i<orderList.size();i++){
            if(customerId.equals(orderList.getNode(i).getObj().getPhone())){
                customer=extendArray(customer);
                customer[customer.length-1] = new Order(orderList.getNode(i).getObj().getCustomerName(),orderList.getNode(i).getObj().getOrderID(),
    ...
    public static Order[] getDeliveredOrders(){
    ...
    public static Order[] getPreparedOrders(){
    ...
    public static Order[] getCanceledOrders(){
    ...
    public static boolean validPhone(String customerPhone) {
        return customerPhone.length()==10 & customerPhone.charAt(0)=='0';
    }
}
